...
//     const deductions80C = parseFloat(formData.deductions80C);
//     const deductionsOther = parseFloat(formData.deductionsOther);
//     const hra          = parseFloat(formData.hra);
//     const rentPaid     = parseFloat(formData.rentPaid);
//     const compare      = formData.compareRegimes;
...
//     setLoading(true);
//     const data = calculateIncomeTax(income, deductions80C, deductionsOther, hra, rentPaid, compare);
//     setResult(data);
//     setLoading(false);
...
//                   min="0"
//                   step="10000"
//                   helpText="House Rent Allowance (annual)"
//                 />
...
//                   min="0"
//                   step="10000"
//                   helpText="Annual rent (for HRA exemption)"
//                 />
...
//                         </div>
//                         <div className={styles.emiValue} style={{ fontSize: '1.5rem' }}>
...
//                           <strong> ₹{formatCurrency(result.savings)}</strong> compared to {result.betterRegime === 'old' ? 'New' : 'Old'} Regime.
//                         </p>
...
//                         </p>
//                         <p style={{ marginTop: '1rem', padding: '0.75rem', background: result.betterRegime === 'old' ? '#f0fdf4' : '#fef3c7', borderRadius: '0.5rem' }}>
//                           💡 Net monthly take-home: <strong>₹{formatCurrency(result.betterRegime === 'old' ? result.old.monthlyIncome : result.new.monthlyIncome)}</strong>
//                         </p>
//                       </div>
//                     </Card>
...
//                 <tr><td style={{ padding: '0.25rem' }}>₹3L - ₹6L</td><td style={{ padding: '0.25rem', textAlign: 'right' }}>5%</td></tr>
//                 <tr><td style={{ padding: '0.25rem' }}>₹6L - ₹9L</td><td style={{ padding: '0.25rem', textAlign: 'right' }}>10%</td></tr>
//                 <tr><td style={{ padding: '0.25rem' }}>₹9L - ₹12L</td><td style={{ padding: '0.25rem', textAlign: 'right' }}>15%</td></tr>
...
//                 <tr><td style={{ padding: '0.25rem' }}>Home loan (80C + interest)</td><td style={{ padding: '0.25rem', textAlign: 'center', color: '#059669', fontWeight: 600 }}>Old</td></tr>
...
//           <h3>How to Save Tax</h3>
//           <ul>
//             <li><strong>Maximize 80C:</strong> EPF, PPF, ELSS, Insurance (₹1.5L)</li>
//             <li><strong>Claim HRA:</strong> If paying rent (save ₹50K-₹1L tax)</li>
//             <li><strong>Health Insurance:</strong> 80D deduction (₹25K-₹50K)</li>
//             <li><strong>Home Loan:</strong> ₹2L interest + ₹1.5L principal (80C)</li>
//             <li><strong>NPS Additional:</strong> 80CCD(1B) extra ₹50K</li>
//             <li><strong>Education Loan:</strong> Full interest deduction (80E)</li>
//           </ul>

//           <h3>Important Notes</h3>
//           <ul>
//             <li>Financial Year: Apr 1, 2024 - Mar 31, 2025</li>
//             <li>Assessment Year: 2025-26</li>
//             <li>ITR Filing Deadline: July 31, 2025</li>
//             <li>Surcharge: 10% if income &gt;₹50L, 15% if &gt;₹1Cr, 25% if &gt;₹2Cr</li>
//             <li>Rebate 87A: Full tax rebate if income &lt;₹7L (new regime)</li>
//           </ul>

//           <h3>Example Calculation</h3>
//           <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '0.5rem', marginTop: '1rem' }}>
//             <p><strong>Income:</strong> ₹12,00,000 | <strong>80C:</strong> ₹1,50,000 | <strong>Rent:</strong> ₹1,80,000/year</p>
//             <p style={{ marginTop: '1rem' }}><strong>Old Regime:</strong></p>
//             <ul style={{ fontSize: '0.875rem', marginLeft: '1.5rem' }}>
//               <li>Gross: ₹12,00,000</li>
//               <li>Standard Deduction: -₹50,000</li>
//               <li>80C: -₹1,50,000</li>
//               <li>HRA: -₹1,20,000</li>
//               <li>Taxable: ₹8,80,000</li>
//               <li>Tax: ₹1,14,400 + Cess = <strong>₹1,18,976</strong></li>
//             </ul>
//             <p style={{ marginTop: '1rem' }}><strong>New Regime:</strong></p>
//             <ul style={{ fontSize: '0.875rem', marginLeft: '1.5rem' }}>
//               <li>Gross: ₹12,00,000</li>
//               <li>Standard Deduction: -₹50,000</li>
//               <li>Taxable: ₹11,50,000</li>
//               <li>Tax: ₹1,35,000 + Cess = <strong>₹1,40,400</strong></li>
//             </ul>
//             <p style={{ marginTop: '1rem', color: '#059669', fontWeight: 600 }}>
//               Old Regime saves ₹21,424!
//             </p>
//           </div>
//         </Card>
