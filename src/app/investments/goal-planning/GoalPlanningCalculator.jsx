              ...
              <>
                <Card variant="gradient" className={styles.emiCard}>
                  <div className={styles.emiResult}>
                    ...
                    <div className={styles.emiValue}>{formatCurrency(result?.futureValue ?? 0)}</div>
                  </div>
                </Card>
                  ...
                  <div className={styles.summaryGrid}>
                    ...
                    <div className={styles.summaryItem}>
                      ...
                      <div className={styles.summaryValue} style={{ color: '#ef4444' }}>
                        ...
                        {result?.targetAmount > 0 ? ((result.futureValue - result.targetAmount) / result.targetAmount * 100).toFixed(1): 0}%
                      </div>
                    </div>
